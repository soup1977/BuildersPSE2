''' <summary>
''' Model representing BisTrack invoice actual data for variance comparison.
''' </summary>
Public Class BisTrackActualModel

    Public Property SalesOrderNumber As String = String.Empty
    ...
    Public Property LevelCount As Integer = 0
