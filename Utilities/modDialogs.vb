...
'                    Dim closingForm As Form = CType(tabToRemove.Controls(0), Form)

'                    ' === REFRESH PROJECT TREE IF A PROJECT-RELATED FORM IS CLOSING ===
'                    If closingForm.Name = "ProjectBuilderForm" Then

'                        Dim projectForm As frmCreateEditProject = CType(Application.OpenForms("frmCreateEditProject"), frmCreateEditProject)
'                        If projectForm IsNot Nothing AndAlso Not projectForm.IsDisposed Then
'                            projectForm.RefreshProjectTree()
'                        End If
'                    End If
'                    ' === END REFRESH ===
